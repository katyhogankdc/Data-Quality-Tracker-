...
LEFT JOIN CUSTOM.CUSTOM_DLPENALTIES_RAW P ON P.INCIDENTID = I.INCIDENTID AND I.INCIDENTID!=-1
...
JOIN CUSTOM.CUSTOM_DLATTENDANCE_RAW A ON A.BEHAVIORDATE = CD.DATE_VALUE AND I.STUDENTSCHOOLID = A.STUDENTSCHOOLID AND BEHAVIORCATEGORY = 'Daily Attendance'
JOIN POWERSCHOOL.POWERSCHOOL_STUDENTS S ON S.STUDENT_NUMBER = I.STUDENTSCHOOLID
...
'DeansList' AS SOURCESYSTEM,
20 ERRORID
FROM CUSTOM.CUSTOM_DLATTENDANCE_RAW A
JOIN POWERSCHOOL.POWERSCHOOL_STUDENTS S ON S.STUDENT_NUMBER = A.STUDENTSCHOOLID
JOIN CUSTOM.CUSTOM_DLSCHOOLBRIDGE SB ON SB.DLSCHOOLID = A.DLSCHOOLID
JOIN POWERSCHOOL.POWERSCHOOL_SCHOOLS SCH ON SCH.SCHOOL_NUMBER = SB.PSSCHOOLID
LEFT JOIN 
(SELECT 
  I.STUDENTSCHOOLID
...
,'DeansList' AS SOURCESYSTEM
,21 ERRORID
FROM CUSTOM.CUSTOM_DLATTENDANCE_RAW ATT
JOIN CUSTOM.CUSTOM_DLSCHOOLBRIDGE SCHB ON SCHB.DLSCHOOLID = ATT.DLSCHOOLID
